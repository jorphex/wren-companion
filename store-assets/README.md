...
Companion renderers, not from a daily browser profile or wallet. The captured
Uniswap page is shown only as a recognizable public dapp example; Wren is not
affiliated with Uniswap.

The v14 listing screenshots use reviewed source captures from the 0.1.0
renderers. The pairing, connected, and review views shown remain representative
for 0.1.2. The Wren captures came from desktop commit
`80e99f7e82db25ac4f4a2cb67c008571f8394b32`. The Companion captures came from
commit `3e3a66bffaa079eb2b50dff14d1523dec3396ccf` and a private disposable browser
profile. Their pairing, connection, network, contract, address, and amount data
has no authority or funds. The pairing code expired with the disposable mock
desktop process.
